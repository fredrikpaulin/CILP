// Pool-backed PackedBuffer test. Apple Silicon only — run `bash build.sh` first.
// Verifies that a PackedBuffer allocated from the Metal pool gives a zero-copy view:
// writes through the view land in the GPU-visible shared buffer and read back. The
